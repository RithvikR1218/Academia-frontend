...
export default function ProfTable({ collegeId, departmentId, researchInterests }) {
  ...
  const rows = professors.map((prof) => (
    <tr key={prof._id}>
      ...
      <td data-label="Research Interests" className="research-td">
        {prof.researchInterests?.join(', ')}
      </td>
    </tr>
  ));
      ...
      <div className="table-div">
        <table className="prof-table table-container">
          <thead>
            <tr>
              <th>
                Save in dashboard<i class="fa-solid fa-sort"></i>
              </th>
              <th>
              ...
              <th>
                College<i class="fa-solid fa-sort"></i>
              </th>
              <th>
                Department<i class="fa-solid fa-sort"></i>
              </th>
              <th>
                Position<i class="fa-solid fa-sort"></i>
              </th>
              <th>
                Research Interests<i class="fa-solid fa-sort"></i>
              </th>
            </tr>
          </thead>
          <tbody>{rows}</tbody>
