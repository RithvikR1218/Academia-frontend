        ...
        <div className="features-section">
          <div className="feature-div">
            ...
            <p className="feature-p">
              Find professors around the world and filter by their College, Department, or Research
              Interests.
            </p>
          </div>
          <div className="feature-div">
            ...
            <p className="feature-p">
              Access a user-specific dashboard to save professor profiles, organize research files,
          ...
          <div className="feature-div">
            ...
            <p className="feature-p">
              Get summaries of professors' recent papers to understand their research and write cold
